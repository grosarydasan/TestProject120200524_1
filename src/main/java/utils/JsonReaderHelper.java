...
//        JsonElement root  = new JsonParser.parse(new FileReader(filename System.getProperty("src/main/resources/data/loginData.json"));
//        Gson gson = new Gson();
//        LoginData[] loginData= gson.fromJson("");
//        return loginData;
